...
const MOVEER_MISSING_CONNECT_PERMISSION =
  "Hey! Please make sure i got 'CONNECT' permissions in the voicechannel named ";
const MOVEER_MISSING_MOVE_PERMISSION =
  "Hey! Please make sure i got 'MOVE_MEMBERS' permissions in the voicechannel named ";
const MESSAGE_MISSING_ROOM_IDENTIFER =
  'You need to write a number to identify a gMoveer room!';
const MOVE_MESSAGE_CONTAINS_MENTIONS =
...
const CMOVE_OUTSIDE_MOVEERADMIN =
  'This is an admin command, please use this inside a textchannel named "moveeradmin" or add one of your choice by writing !changema #<channelName> (First time is required to be done inside moveeradmin)';
const CMOVE_MESSAGE_MISSING_ROOM_IDENTIFER =
  'You need to specify a voice channel!';
  ...
  embed: {
    ...
    fields: [
      ...
      },
      {
        name: 'ymove',
        value:
          'Spreads x user from one channel to different voice channels inside a category'
      },
      {
        name: 'av',
        value:
          'A command for wow vanilla. Channels should be created as "AV 1" to "AV 500" - Users then write `!av 123` to get moved to "AV 123" Commands must be sent inside av-numbers or av-verified'
      },
      {
        name: 'changema',
        value:
          'Allows moveeradmin commands to be sent from a secondary textchannel of your choice \n`!changema #<channelName>`\n\nFor more information, use !help <command>'
      }
    ]
  }
};
    ...
    fields: [
      {
        name: '!av',
        value:
          '0. Voicechannels must be named "AV 1" to "AV 500" and commands must be sent inside "av-numbers" or "av-verified"\n1. Write `!av <channelId>`\n2. Moveer should move you to the correct AV channel.'
      }
    ]
  }
};
